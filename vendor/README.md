...
## `nemo_sandboxed_gym-0.1.0-py3-none-any.whl`
...
**Temporary.** `pyproject.toml` already requires `nemo-sandboxed-gym==0.1.0`, the version
...
```bash
UV_DYNAMIC_VERSIONING_BYPASS=0.1.0 uv build --package nemo-sandboxed-gym -o <dest>
```
